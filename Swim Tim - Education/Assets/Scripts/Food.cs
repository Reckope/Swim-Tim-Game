...
public class Food : MonoBehaviour {
	...
	private void OnTriggerEnter2D (Collider2D other)			// When Tim collects the fish food...
	{
		if (other.GetComponent<Tim> () != null) 
		{
			...
			GameControl.instance.scrollSpeed = (GameControl.instance.scrollSpeed - (float)0.08); 			// Make the game go faster when a fish is collected.
			GameControl.instance.tunaSpeed = (GameControl.instance.tunaSpeed - (float)0.06);
			GameControl.instance.enemySpeed = (GameControl.instance.enemySpeed - (float)0.08);
